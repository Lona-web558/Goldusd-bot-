...
function executeTrade() {
	...
	balance += parseFloat(profitAmount);
...
function deposit() {
	...
	showNotification('Deposit Successful', `$${amount.toFixed(2)} added to your balance`, 'success' );
}
...
function withdraw() {
	...
	showNotification('Withdrawal Successful', `$${amount.toFixed(2)} withdrawn from your balance`, 'success');
}
